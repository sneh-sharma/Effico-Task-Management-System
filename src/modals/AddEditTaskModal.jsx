  ...
  return (
    ...
    >
      ...
      <div
       ...
       shadow-md shadow-[#364e7e1a] max-w-md mx-auto  w-full px-8  py-8 rounded-xl font-serif"
      >
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <textarea
            ...
            placeholder="e.g. Go out!! Take a walk and enjoy the sunset!!!"
          />
        </div>
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          {subtasks.map((subtask, index) => (
            <div key={index} className=" flex items-center w-full ">
              <input
                ...
                placeholder=" e.g Take tea break"
              />
              <img
                src={crossIcon}
                onClick={() => {
          ...
          <button
            className=" w-full items-center dark:text-white dark:bg-[#635fc7]  text-white bg-[#635fc7] py-2 rounded-full "
            onClick={() => {
              setSubtasks((state) => [
                ...state,
                { title: "", isCompleted: false, id: uuidv4() },
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <select
            ...
            className=" select-status flex-grow px-4 py-2 rounded-md text-sm dark:text-black text-black bg-gray-100 focus:border-0  border-[1px] border-gray-300 focus:outline-[#635fc7] "
          >
